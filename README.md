...
- 같은 규칙이 exact artifact hash와 provenance blocker, 분리된 번역·소설 suite, synthetic case, 닫힌 inference request/result/error/receipt schema와 admission fail fixture까지 검사한다.
