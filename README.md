...
- `zdp-privacy-credential-vault` 저장소 루트의 credential boundary, capability issuance, access audit, storage boundary 계약이 connector/product/AI/analytics 경계로 raw credential을 새게 만들거나 audit/restore/log에 raw secret을 남기지 않는지 검사한다.
