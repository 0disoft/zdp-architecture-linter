...
- `zdp-growth-lab` 저장소 루트의 funnel metric, growth experiment, experiment safety 계약이 CAC/LTV/CLV 정본이나 직접 DB 조회로 번지지 않는지 검사한다.
