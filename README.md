...
- `zdp-client-sdks` 저장소 루트의 SDK generation source handoff, libs export source handoff, sdk surface, auth helper, upload client 계약과 checker skeleton이 SDK 구현 전 gate로 유지되는지 검사한다.
