...
- `zdp-platform-security` 저장소 루트의 security baseline, threat model template, secret handling, dependency review 계약이 scanner 구현 전 gate로 유지되는지 검사한다.
