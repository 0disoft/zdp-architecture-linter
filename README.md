...
- AI 사용자 데이터 접근, 민감 AI 데이터의 모델 제공자 보관·학습 정책, 외부 제공자, 웹훅, 감사, 티어별 운영 기준의 차단 규칙을 실행한다.
